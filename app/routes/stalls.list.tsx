...
export const Route = createFileRoute("/stalls/list")({
...
function StallsPageComponent() {
  ...
  const columns = React.useMemo(
    () => [
      ...
      columnHelper.accessor("currentHorse.name", {
      ...
      columnHelper.accessor("lastCleaned", {
        header: "Last Cleaned",
        cell: (info) => formatDate(info.getValue()),
        footer: (info) => info.column.id,
      }),
      columnHelper.accessor("nextScheduledMaintenance", {
        header: "Next Scheduled Maintenance",
        cell: (info) => formatDate(info.getValue()),
        footer: (info) => info.column.id,
      }),
      columnHelper.accessor("customizations", {
