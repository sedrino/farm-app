      ...
      columnHelper.display({
        ...
        cell: (info) => (
          <div className="flex space-x-2">
            <Button asChild>
              <Link to={`/finance/income/${info.row.original.incomeId}/edit`}>
                Edit
              </Link>
            </Button>
      ...
      <Panel className="p-4">
        <div className="mb-4 flex items-center justify-between">
          <Button variant="default" asChild>
            <Link to="/finance/income/create">Add New Income</Link>
          </Button>
        ...
        <BasicTable
          columns={columns}
          data={data}
          caption="List of income transactions."
        />
        {/* Add summary statistics and export functionality here */}
      </Panel>
    </div>
  );
}
