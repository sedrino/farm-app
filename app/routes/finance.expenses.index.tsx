      ...
      columnHelper.accessor("vendor", {
        ...
        cell: (info) => (
          <Button variant="link" asChild>
            <Link to={`/finance/expenses/${info.row.original.expenseId}`}>
              {info.getValue()}
            </Link>
          </Button>
        ),
      ...
      columnHelper.display({
        ...
        cell: (info) => (
          <div className="flex space-x-2">
            <Button asChild>
              <Link
                to={`/finance/expenses/${info.row.original.expenseId}/edit`}
              >
                Edit
              </Link>
            </Button>
      ...
      <Panel className="p-4">
        <div className="mb-4 flex items-center justify-between">
          ...
          <Button variant="default" asChild>
            <Link to="/finance/expenses/create">Add New Expense</Link>
          </Button>
        </div>
