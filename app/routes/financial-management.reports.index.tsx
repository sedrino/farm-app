...
export const Route = createFileRoute("/financial-management/reports/")({
      ...
      columnHelper.accessor("reportName", {
        ...
        cell: (info) => (
          <Button variant="link" asChild>
            <Link
              to={"/financial-management/reports/$reportId/edit"}
      ...
      <Panel className="p-4">
        <div className="mb-4 flex items-center justify-between">
          <Button variant="default" asChild>
            <Link to={"/financial-management/reports/create"}>
              Generate New Report
            </Link>
          </Button>
        </div>
